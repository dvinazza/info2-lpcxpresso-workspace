...
#define		PINMODE1	*( ( registro  * ) 0x4002C044)

// ADC

#define		AD0CR		*( ( registro  * ) 0x40034000)
#define		AD0DR0		( ( registro  * ) 0x40034010)
#define		AD0INTEN	*( ( registro  * ) 0x4003400C)
// DAC
#define		DACR		*( ( registro  * ) 0x4008C000)
...
#define		IPR1			*( ( registro  * ) 0xE000E404)
#define		IPR5			*( ( registro  * ) 0xE000E414)
